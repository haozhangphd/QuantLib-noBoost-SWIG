...
typedef std::shared_ptr<CalibrationHelper> SwaptionHelperPtr;
typedef std::shared_ptr<CalibrationHelper> CapHelperPtr;
typedef std::shared_ptr<CalibrationHelper> HestonModelHelperPtr;
%}
...
%template(CalibrationHelper) std::shared_ptr<CalibrationHelper>;
%extend std::shared_ptr<CalibrationHelper> {
    ...
    Date swaptionExpiryDate() {
        std::shared_ptr<SwaptionHelper> s = std::dynamic_pointer_cast<SwaptionHelper>(*self);
...
class SwaptionHelperPtr : public std::shared_ptr<CalibrationHelper> {
  public:
    %extend {
...
class CapHelperPtr : public std::shared_ptr<CalibrationHelper> {
  public:
    %extend {
...
class HestonModelHelperPtr : public std::shared_ptr<CalibrationHelper> {
  public:
	%extend {
...
SWIG_STD_VECTOR_ENHANCED( std::shared_ptr<CalibrationHelper> )
#endif
namespace std {
    %template(CalibrationHelperVector)
        vector<std::shared_ptr<CalibrationHelper> >;
}
...
%template(CalibratedModel) std::shared_ptr<CalibratedModel>;
IsObservable(std::shared_ptr<CalibratedModel>);
