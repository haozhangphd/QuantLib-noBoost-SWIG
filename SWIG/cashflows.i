...
%template(CashFlow) std::shared_ptr<CashFlow>;
IsObservable(std::shared_ptr<CashFlow>);

#if defined(SWIGCSHARP)
SWIG_STD_VECTOR_ENHANCED( std::shared_ptr<CashFlow> )
#endif
%template(Leg) std::vector<std::shared_ptr<CashFlow> >;
...
typedef std::shared_ptr<CashFlow> SimpleCashFlowPtr;
typedef std::shared_ptr<CashFlow> RedemptionPtr;
typedef std::shared_ptr<CashFlow> AmortizingPaymentPtr;
typedef std::shared_ptr<CashFlow> CouponPtr;
typedef std::shared_ptr<CashFlow> IborCouponPtr;
typedef std::shared_ptr<CashFlow> FixedRateCouponPtr;
typedef std::shared_ptr<CashFlow> FloatingRateCouponPtr;
%}

%rename(SimpleCashFlow) SimpleCashFlowPtr;
class SimpleCashFlowPtr : public std::shared_ptr<CashFlow> {
  public:
    %extend {
...
class RedemptionPtr : public std::shared_ptr<CashFlow> {
  public:
    %extend {
...
class AmortizingPaymentPtr : public std::shared_ptr<CashFlow> {
  public:
    %extend {
...
class CouponPtr : public std::shared_ptr<CashFlow> {
  private:
    CouponPtr();
  public:
    %extend {
        Real nominal() {
            return std::dynamic_pointer_cast<Coupon>(*self)->nominal();
        }
        Date accrualStartDate() {
            return std::dynamic_pointer_cast<Coupon>(*self)
                ->accrualStartDate();
        }
        Date accrualEndDate() {
            return std::dynamic_pointer_cast<Coupon>(*self)
        ...
        Real rate() {
            return std::dynamic_pointer_cast<Coupon>(*self)->rate();
        }
        Time accrualPeriod() {
            return std::dynamic_pointer_cast<Coupon>(*self)
                ->accrualPeriod();
...
%inline %{
    CouponPtr as_coupon(const std::shared_ptr<CashFlow>& cf) {
        return std::dynamic_pointer_cast<Coupon>(cf);
    }
%}
  ...
  public:
    %extend {
        ...
        InterestRate interestRate() {
            return std::dynamic_pointer_cast<FixedRateCoupon>(*self)
                ->interestRate();
        }
    }
};
...
%inline %{
    FixedRateCouponPtr as_fixed_rate_coupon(
        ...
        return std::dynamic_pointer_cast<FixedRateCoupon>(cf);
    }
%}
...
%template(FloatingRateCouponPricer) std::shared_ptr<FloatingRateCouponPricer>;
...
class FloatingRateCouponPtr : public CouponPtr {
  ...
  public:
    %extend {
        Date fixingDate() {
            return std::dynamic_pointer_cast<FloatingRateCoupon>(*self)
                ->fixingDate();
        }
        Integer fixingDays() {
            return std::dynamic_pointer_cast<FloatingRateCoupon>(*self)
        ...
        void setPricer(const std::shared_ptr<FloatingRateCouponPricer>& p) {
            std::dynamic_pointer_cast<FloatingRateCoupon>(*self)
                ->setPricer(p);
        }
    }
};
...
%inline %{
    FloatingRateCouponPtr as_floating_rate_coupon(
                                      const std::shared_ptr<CashFlow>& cf) {
        return std::dynamic_pointer_cast<FloatingRateCoupon>(cf);
    }
%}
...
typedef std::shared_ptr<CashFlow> CappedFlooredCouponPtr;
%}
  ...
  public:
    %extend {
        CappedFlooredCouponPtr(const FloatingRateCouponPtr& underlying,
            ...
            std::shared_ptr<FloatingRateCoupon> u =
                std::dynamic_pointer_cast<FloatingRateCoupon>(underlying);
            return new CappedFlooredCouponPtr(
                new CappedFlooredCoupon(u,cap,floor));
        }
        Rate cap() {
           return std::dynamic_pointer_cast<CappedFlooredCoupon>(*self)
                ->cap();
        }
        Rate floor() {
           return std::dynamic_pointer_cast<CappedFlooredCoupon>(*self)
        ...
        void setPricer(const std::shared_ptr<FloatingRateCouponPricer>& p) {
            std::dynamic_pointer_cast<CappedFlooredCoupon>(*self)
                ->setPricer(p);
        }
    }
};
  ...
  public:
    %extend {
        IborCouponPtr(const Date& paymentDate, Real nominal,
            ...
            const std::shared_ptr<IborIndex> iri =
...
typedef std::shared_ptr<FloatingRateCouponPricer> IborCouponPricerPtr;
typedef std::shared_ptr<FloatingRateCouponPricer> BlackIborCouponPricerPtr;
%}

%rename(IborCouponPricer) IborCouponPricerPtr;
class IborCouponPricerPtr : public std::shared_ptr<FloatingRateCouponPricer> {
  private:
    IborCouponPricerPtr();
  public:
    %extend {
        Handle<OptionletVolatilityStructure> capletVolatility() {
            return std::dynamic_pointer_cast<IborCouponPricer>(*self)
                ->capletVolatility();
        }
        void setCapletVolatility(const Handle<OptionletVolatilityStructure>& v =
                                     Handle<OptionletVolatilityStructure>()) {
            std::dynamic_pointer_cast<IborCouponPricer>(*self)
...
typedef std::shared_ptr<CashFlow> CmsCouponPtr;
typedef std::shared_ptr<CashFlow> CappedFlooredCmsCouponPtr;
%}
...
typedef std::shared_ptr<FloatingRateCouponPricer> CmsCouponPricerPtr;
typedef std::shared_ptr<FloatingRateCouponPricer> AnalyticHaganPricerPtr;
typedef std::shared_ptr<FloatingRateCouponPricer> NumericHaganPricerPtr;
typedef std::shared_ptr<FloatingRateCouponPricer> LinearTsrPricerPtr;
%}

%rename(CmsCouponPricer) CmsCouponPricerPtr;
class CmsCouponPricerPtr : public std::shared_ptr<FloatingRateCouponPricer> {
  private:
    CmsCouponPricerPtr();
  public:
    %extend {
        Handle<SwaptionVolatilityStructure> swaptionVolatility() {
            return std::dynamic_pointer_cast<CmsCouponPricer>(*self)
                ->swaptionVolatility();
        }
        void setSwaptionVolatility(
                                const Handle<SwaptionVolatilityStructure>& v =
                                      Handle<SwaptionVolatilityStructure>()) {
            std::dynamic_pointer_cast<CmsCouponPricer>(*self)
