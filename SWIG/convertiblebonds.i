...
typedef std::shared_ptr<Instrument> ConvertibleZeroCouponBondPtr;
typedef std::shared_ptr<Instrument> ConvertibleFixedCouponBondPtr;
typedef std::shared_ptr<Instrument> ConvertibleFloatingRateBondPtr;
typedef std::shared_ptr<PricingEngine> BinomialConvertibleEnginePtr;
%}
  ...
  public:
    %extend {
        ConvertibleZeroCouponBondPtr(
              ...
              const std::vector<std::shared_ptr<Dividend> >& dividends,
              const std::vector<std::shared_ptr<Callability> >& callability,
...
class BinomialConvertibleEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
