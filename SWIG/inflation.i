...
%{
  ...
  typedef std::shared_ptr<Seasonality> MultiplicativePriceSeasonalityPtr;
%}
...
%template(Seasonality) std::shared_ptr<Seasonality>;

class MultiplicativePriceSeasonalityPtr
    : public std::shared_ptr<Seasonality> {
  public:
    %extend {
...
%template(YoYInflationTermStructure)
    std::shared_ptr<YoYInflationTermStructure>;
IsObservable(std::shared_ptr<YoYInflationTermStructure>);
...
%template(ZeroInflationTermStructure)
    std::shared_ptr<ZeroInflationTermStructure>;
IsObservable(std::shared_ptr<ZeroInflationTermStructure>);
...
typedef std::shared_ptr<Index> InflationIndexPtr;
typedef std::shared_ptr<Index> ZeroInflationIndexPtr;
typedef std::shared_ptr<Index> YoYInflationIndexPtr;
}
...
class InflationIndexPtr : public std::shared_ptr<Index> {
  protected:
    InflationIndexPtr();
  public:
    %extend {
        bool interpolated() const {
            return std::dynamic_pointer_cast<InflationIndex>(*self)
                ->interpolated();
        }
...
%{
using QuantLib::Name;
typedef std::shared_ptr<Index> Name##Ptr;
%}
...
typedef std::shared_ptr<ZeroHelper> ZeroCouponInflationSwapHelperPtr;

using QuantLib::YearOnYearInflationSwapHelper;
typedef std::shared_ptr<YoYHelper> YearOnYearInflationSwapHelperPtr;
%}

%template(ZeroHelper) std::shared_ptr<ZeroHelper>;
%template(YoYHelper) std::shared_ptr<YoYHelper>;

#if defined(SWIGCSHARP)
SWIG_STD_VECTOR_ENHANCED( std::shared_ptr<ZeroHelper> )
SWIG_STD_VECTOR_ENHANCED( std::shared_ptr<YoYHelper> )
#endif
namespace std {
    %template(ZeroHelperVector) vector<std::shared_ptr<ZeroHelper> >;
    %template(YoYHelperVector) vector<std::shared_ptr<YoYHelper> >;
}

%rename(ZeroCouponInflationSwapHelper) ZeroCouponInflationSwapHelperPtr;
class ZeroCouponInflationSwapHelperPtr : public std::shared_ptr<ZeroHelper> {
  public:
    %extend {
        ZeroCouponInflationSwapHelperPtr(Rate rate,
            ...
            Handle<Quote> quote(
                std::shared_ptr<Quote>(new SimpleQuote(rate)));
            std::shared_ptr<ZeroInflationIndex> zeroIndex =
                std::dynamic_pointer_cast<ZeroInflationIndex>(index);
...
class YearOnYearInflationSwapHelperPtr : public std::shared_ptr<YoYHelper> {
  public:
    %extend {
        YearOnYearInflationSwapHelperPtr(Rate rate,
            ...
            std::shared_ptr<YoYInflationIndex> yoyIndex =
                std::dynamic_pointer_cast<YoYInflationIndex>(index);
...
%{
typedef std::shared_ptr<ZeroInflationTermStructure> Name##Ptr;
%}
%rename(Name) Name##Ptr;
class Name##Ptr : public std::shared_ptr<ZeroInflationTermStructure> {
  ...
  public:
    %extend {
        Name##Ptr(
              ...
              const std::vector<std::shared_ptr<ZeroHelper> >& instruments,
        ...
        const std::vector<Date>& dates() {
            ...
            return std::dynamic_pointer_cast<Name>(*self)->dates();
        }
        const std::vector<Time>& times() {
            typedef PiecewiseZeroInflationCurve<Interpolator> Name;
            return std::dynamic_pointer_cast<Name>(*self)->times();
        }
        #if !defined(SWIGR) && !defined(SWIGGUILE) && !defined(SWIGMZSCHEME)
        std::vector<std::pair<Date,Real> > nodes() {
            typedef PiecewiseZeroInflationCurve<Interpolator> Name;
            return std::dynamic_pointer_cast<Name>(*self)->nodes();
        }
        #endif
    }
};
...
%{
typedef std::shared_ptr<YoYInflationTermStructure> Name##Ptr;
%}
%rename(Name) Name##Ptr;
class Name##Ptr : public std::shared_ptr<YoYInflationTermStructure> {
    #if !defined(SWIGJAVA) && !defined(SWIGCSHARP)
    %feature("kwargs") Name##Ptr;
    #endif
  public:
    %extend {
        Name##Ptr(
              ...
              Rate baseRate,
              const Handle<YieldTermStructure>& nominalTS,
              const std::vector<std::shared_ptr<YoYHelper> >& instruments,
              Real accuracy = 1.0e-12,
              const Interpolator& i = Interpolator()) {
            return new Name##Ptr(
...
typedef std::shared_ptr<Instrument> ZeroCouponInflationSwapPtr;
typedef std::shared_ptr<Instrument> YearOnYearInflationSwapPtr;
%}
...
class ZeroCouponInflationSwapPtr : public std::shared_ptr<Instrument> {
    #if defined(SWIGMZSCHEME) || defined(SWIGGUILE)
  ...
  public:
    %extend {
        ...
        Rate fairRate() {
            return std::dynamic_pointer_cast<ZeroCouponInflationSwap>(*self)
                ->fairRate();
        }
        std::vector<std::shared_ptr<CashFlow> > fixedLeg() {
            return std::dynamic_pointer_cast<ZeroCouponInflationSwap>(*self)
                ->fixedLeg();
        }
        std::vector<std::shared_ptr<CashFlow> > inflationLeg() {
            return std::dynamic_pointer_cast<ZeroCouponInflationSwap>(*self)
                ->inflationLeg();
        }
        ZeroCouponInflationSwap::Type type() {
...
class YearOnYearInflationSwapPtr : public std::shared_ptr<Instrument> {
    #if defined(SWIGMZSCHEME) || defined(SWIGGUILE)
    %rename("fair-rate")        fairRate;
    #endif
  public:
    %extend {
        ...
        Rate fairRate() {
            return std::dynamic_pointer_cast<YearOnYearInflationSwap>(*self)
                ->fairRate();
        }
    }
};
...
typedef std::shared_ptr<Instrument> YoYInflationCapFloorPtr;
typedef std::shared_ptr<Instrument> YoYInflationCapPtr;
typedef std::shared_ptr<Instrument> YoYInflationFloorPtr;
typedef std::shared_ptr<Instrument> YoYInflationCollarPtr;
%}

%rename(YoYInflationCapFloor) YoYInflationCapFloorPtr;
class YoYInflationCapFloorPtr : public std::shared_ptr<Instrument> {
    #if defined(SWIGMZSCHEME) || defined(SWIGGUILE)
  ...
  public:
     %extend {
         Volatility impliedVolatility(
             ...
             return std::dynamic_pointer_cast<YoYInflationCapFloor>(*self)->
