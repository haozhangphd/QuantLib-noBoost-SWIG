...
%template(BoundaryCondition) std::shared_ptr<DefaultBoundaryCondition>;
%extend std::shared_ptr<DefaultBoundaryCondition> {
...
typedef std::shared_ptr<DefaultBoundaryCondition> NeumannBCPtr;
typedef std::shared_ptr<DefaultBoundaryCondition> DirichletBCPtr;
%}

%rename(NeumannBC) NeumannBCPtr;
class NeumannBCPtr: public std::shared_ptr<DefaultBoundaryCondition> {
  public:
    %extend {
...
class DirichletBCPtr: public std::shared_ptr<DefaultBoundaryCondition> {
  public:
    %extend {
