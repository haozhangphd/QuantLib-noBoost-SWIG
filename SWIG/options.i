...
%template(Payoff) std::shared_ptr<Payoff>;
...
%extend Type##Ptr {
    Real delta() {
        return std::dynamic_pointer_cast<Type>(*self)->delta();
    }
    Real gamma() {
        return std::dynamic_pointer_cast<Type>(*self)->gamma();
    }
    Real theta() {
        return std::dynamic_pointer_cast<Type>(*self)->theta();
    }
    Real thetaPerDay() {
        return std::dynamic_pointer_cast<Type>(*self)->thetaPerDay();
    }
    Real vega() {
        return std::dynamic_pointer_cast<Type>(*self)->vega();
    }
    Real rho() {
        return std::dynamic_pointer_cast<Type>(*self)->rho();
    }
    Real dividendRho() {
        return std::dynamic_pointer_cast<Type>(*self)->dividendRho();
    }
    Real strikeSensitivity() {
        return std::dynamic_pointer_cast<Type>(*self)->strikeSensitivity();
    }
}
...
typedef std::shared_ptr<Instrument> VanillaOptionPtr;
typedef std::shared_ptr<Instrument> MultiAssetOptionPtr;
%}


%rename(VanillaOption) VanillaOptionPtr;
class VanillaOptionPtr : public std::shared_ptr<Instrument> {
    #if defined(SWIGMZSCHEME) || defined(SWIGGUILE)
  ...
  public:
    %extend {
        VanillaOptionPtr(
            ...
            std::shared_ptr<StrikedTypePayoff> stPayoff =
                 std::dynamic_pointer_cast<StrikedTypePayoff>(payoff);
            QL_REQUIRE(stPayoff, "wrong payoff given");
            return new VanillaOptionPtr(new VanillaOption(stPayoff,exercise));
        }
        SampledCurve priceCurve() {
            return std::dynamic_pointer_cast<VanillaOption>(*self)
...
typedef std::shared_ptr<Instrument> EuropeanOptionPtr;
%}
...
%{
using QuantLib::ForwardVanillaOption;
typedef std::shared_ptr<Instrument> ForwardVanillaOptionPtr;
%}
...
typedef std::shared_ptr<Instrument> QuantoVanillaOptionPtr;
%}
...
class QuantoVanillaOptionPtr : public VanillaOptionPtr {
  public:
    %extend {
        ...
        Real qvega() {
            return std::dynamic_pointer_cast<QuantoVanillaOption>(*self)
                ->qvega();
        }
        Real qrho() {
            return std::dynamic_pointer_cast<QuantoVanillaOption>(*self)
...
typedef std::shared_ptr<Instrument> QuantoForwardVanillaOptionPtr;
%}
...
class MultiAssetOptionPtr : public std::shared_ptr<Instrument> {
  public:
    %extend {
        Real delta() {
            return std::dynamic_pointer_cast<MultiAssetOption>(*self)
                ->delta();
        }
        Real gamma() {
            return std::dynamic_pointer_cast<MultiAssetOption>(*self)
        ...
        Real vega() {
            return std::dynamic_pointer_cast<MultiAssetOption>(*self)->vega();
        }
        Real rho() {
            return std::dynamic_pointer_cast<MultiAssetOption>(*self)->rho();
        }
        Real dividendRho() {
            return std::dynamic_pointer_cast<MultiAssetOption>(*self)
                ->dividendRho();
...
typedef std::shared_ptr<PricingEngine> AnalyticEuropeanEnginePtr;
%}

%rename(AnalyticEuropeanEngine) AnalyticEuropeanEnginePtr;
class AnalyticEuropeanEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
typedef std::shared_ptr<CalibratedModel> HestonModelPtr;
%}

%rename(HestonModel) HestonModelPtr;
class HestonModelPtr : public std::shared_ptr<CalibratedModel> {
  public:
    %extend {
        HestonModelPtr(const HestonProcessPtr&  process) {

            std::shared_ptr<HestonProcess> hProcess =
                 std::dynamic_pointer_cast<HestonProcess>(process);
            QL_REQUIRE(hProcess, "Heston process required");

            return new HestonModelPtr(new HestonModel(hProcess));
        }
        Real theta() const {
            return std::dynamic_pointer_cast<HestonModel>(*self)->theta();
        }
        Real kappa() const {
            return std::dynamic_pointer_cast<HestonModel>(*self)->kappa();
        }
        Real sigma() const {
            return std::dynamic_pointer_cast<HestonModel>(*self)->sigma();
        }
        Real rho() const {
            return std::dynamic_pointer_cast<HestonModel>(*self)->rho();
        }
        Real v0() const {
            return std::dynamic_pointer_cast<HestonModel>(*self)->v0();
        }
    }
};
...
typedef std::shared_ptr<CalibratedModel> PiecewiseTimeDependentHestonModelPtr;
%}

%rename(PiecewiseTimeDependentHestonModel) PiecewiseTimeDependentHestonModelPtr;
class PiecewiseTimeDependentHestonModelPtr : public std::shared_ptr<CalibratedModel> {
    public:
      %extend {
        ...
        Real theta(Time t) const { 
            return std::dynamic_pointer_cast<PiecewiseTimeDependentHestonModel>(*self)->theta(t);
        }
        Real kappa(Time t) const {
            return std::dynamic_pointer_cast<PiecewiseTimeDependentHestonModel>(*self)->kappa(t);
        }
        Real sigma(Time t) const {
            return std::dynamic_pointer_cast<PiecewiseTimeDependentHestonModel>(*self)->sigma(t);
        }
        Real rho(Time t)   const { 
            return std::dynamic_pointer_cast<PiecewiseTimeDependentHestonModel>(*self)->rho(t);
        }
        Real v0()          const { 
            return std::dynamic_pointer_cast<PiecewiseTimeDependentHestonModel>(*self)->v0();
        }
        Real s0()          const { 
            return std::dynamic_pointer_cast<PiecewiseTimeDependentHestonModel>(*self)->s0();
        }
        const TimeGrid& timeGrid() const {
            return std::dynamic_pointer_cast<PiecewiseTimeDependentHestonModel>(*self)->timeGrid();
        }
        const Handle<YieldTermStructure>& dividendYield() const {
            return std::dynamic_pointer_cast<PiecewiseTimeDependentHestonModel>(*self)->dividendYield();
        }
        const Handle<YieldTermStructure>& riskFreeRate() const {
            return std::dynamic_pointer_cast<PiecewiseTimeDependentHestonModel>(*self)->riskFreeRate();
        }
...
typedef std::shared_ptr<PricingEngine> AnalyticHestonEnginePtr;
%}

%rename(AnalyticHestonEngine) AnalyticHestonEnginePtr;
class AnalyticHestonEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
        AnalyticHestonEnginePtr(const HestonModelPtr& model, 
                                Size integrationOrder = 144) {
            std::shared_ptr<HestonModel> hModel =
                 std::dynamic_pointer_cast<HestonModel>(model);
...
typedef std::shared_ptr<PricingEngine> AnalyticPTDHestonEnginePtr;
%}

%rename(AnalyticPTDHestonEngine) AnalyticPTDHestonEnginePtr;
class AnalyticPTDHestonEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
        AnalyticPTDHestonEnginePtr(
            const PiecewiseTimeDependentHestonModelPtr & model,
            Real relTolerance, Size maxEvaluations) {
                const std::shared_ptr<PiecewiseTimeDependentHestonModel> hmodel = 
                    std::dynamic_pointer_cast<PiecewiseTimeDependentHestonModel>(model);
...
typedef std::shared_ptr<CalibratedModel> BatesModelPtr;
%}
  ...
  public:
    %extend {
        BatesModelPtr(const BatesProcessPtr&  process) {
            ...
            std::shared_ptr<BatesProcess> bProcess =
                 std::dynamic_pointer_cast<BatesProcess>(process);
            QL_REQUIRE(bProcess, "Bates process required");

            return new BatesModelPtr(new BatesModel(bProcess));
        }
        Real nu() const {
            return std::dynamic_pointer_cast<BatesModel>(*self)->nu();
        }
        Real delta() const {
            return std::dynamic_pointer_cast<BatesModel>(*self)->delta();
        }
        Real lambda() const {
            return std::dynamic_pointer_cast<BatesModel>(*self)->lambda();
        }
    }
};
...
typedef std::shared_ptr<PricingEngine> BatesEnginePtr;
%}

%rename(BatesEngine) BatesEnginePtr;
class BatesEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
        BatesEnginePtr(const BatesModelPtr& model, 
                       Size integrationOrder = 144) {
            std::shared_ptr<BatesModel> bModel =
                 std::dynamic_pointer_cast<BatesModel>(model);
...
typedef std::shared_ptr<PricingEngine> IntegralEnginePtr;
%}

%rename(IntegralEngine) IntegralEnginePtr;
class IntegralEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
typedef std::shared_ptr<PricingEngine> FDBermudanEnginePtr;
%}

%rename(FDBermudanEngine) FDBermudanEnginePtr;
class FDBermudanEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
typedef std::shared_ptr<PricingEngine> FDEuropeanEnginePtr;
%}

%rename(FDEuropeanEngine) FDEuropeanEnginePtr;
class FDEuropeanEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
typedef std::shared_ptr<PricingEngine> BinomialVanillaEnginePtr;
%}

%rename(BinomialVanillaEngine) BinomialVanillaEnginePtr;
class BinomialVanillaEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
        BinomialVanillaEnginePtr(
            ...
            std::shared_ptr<GeneralizedBlackScholesProcess> bsProcess =
                 std::dynamic_pointer_cast<GeneralizedBlackScholesProcess>(
                                                                     process);
            QL_REQUIRE(bsProcess, "Black-Scholes process required");
            std::string s = to_lower_copy(type);
...
typedef std::shared_ptr<PricingEngine> MCEuropeanEnginePtr;
%}

%rename(MCEuropeanEngine) MCEuropeanEnginePtr;
class MCEuropeanEnginePtr : public std::shared_ptr<PricingEngine> {
...
typedef std::shared_ptr<PricingEngine> FDAmericanEnginePtr;
typedef std::shared_ptr<PricingEngine> FDShoutEnginePtr;
%}

%rename(FDAmericanEngine) FDAmericanEnginePtr;
class FDAmericanEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
typedef std::shared_ptr<PricingEngine> FdBlackScholesVanillaEnginePtr;
%}

%rename(FdBlackScholesVanillaEngine) FdBlackScholesVanillaEnginePtr;
class FdBlackScholesVanillaEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
typedef std::shared_ptr<PricingEngine> ContinuousArithmeticAsianLevyEnginePtr;
%}

%rename(ContinuousArithmeticAsianLevyEngine) ContinuousArithmeticAsianLevyEnginePtr;
class ContinuousArithmeticAsianLevyEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
typedef std::shared_ptr<PricingEngine> FdBlackScholesAsianEnginePtr;
%}

%rename(FdBlackScholesAsianEngine) FdBlackScholesAsianEnginePtr;
class FdBlackScholesAsianEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
class FDShoutEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
typedef std::shared_ptr<PricingEngine>
...
typedef std::shared_ptr<PricingEngine> AnalyticDigitalAmericanEnginePtr;
%}
...
typedef std::shared_ptr<PricingEngine> AnalyticDigitalAmericanKOEnginePtr;
%}
...
typedef std::shared_ptr<Instrument> DividendVanillaOptionPtr;
%}


%rename(DividendVanillaOption) DividendVanillaOptionPtr;
class DividendVanillaOptionPtr : public std::shared_ptr<Instrument> {
    #if defined(SWIGMZSCHEME) || defined(SWIGGUILE)
    %rename("dividend-rho")       dividendRho;
    %rename("implied-volatility") impliedVolatility;
    #endif
  public:
    %extend {
        ...
        SampledCurve priceCurve() {
            return std::dynamic_pointer_cast<DividendVanillaOption>(*self)
                ->result<SampledCurve>("priceCurve");
        }
        Volatility impliedVolatility(
                             Real targetValue,
...
typedef std::shared_ptr<PricingEngine> AnalyticDividendEuropeanEnginePtr;
%}
...
typedef std::shared_ptr<PricingEngine> FDDividendEuropeanEnginePtr;
typedef std::shared_ptr<PricingEngine> FDDividendAmericanEnginePtr;
%}
...
typedef std::shared_ptr<Instrument> BarrierOptionPtr;
%}

%rename(BarrierOption) BarrierOptionPtr;
class BarrierOptionPtr : public std::shared_ptr<Instrument> {
    #if defined(SWIGMZSCHEME) || defined(SWIGGUILE)
    %rename("dividend-rho")       dividendRho;
    %rename("implied-volatility") impliedVolatility;
    #endif
  public:
    %extend {
        ...
        SampledCurve priceCurve() {
            return std::dynamic_pointer_cast<BarrierOption>(*self)
                ->result<SampledCurve>("priceCurve");
        }
        Volatility impliedVolatility(
                             Real targetValue,
...
typedef std::shared_ptr<PricingEngine> AnalyticBarrierEnginePtr;
%}
...
typedef std::shared_ptr<PricingEngine> MCBarrierEnginePtr;
%}

%rename(MCBarrierEngine) MCBarrierEnginePtr;
class MCBarrierEnginePtr : public std::shared_ptr<PricingEngine> {
    #if !defined(SWIGJAVA) && !defined(SWIGCSHARP)
...
typedef std::shared_ptr<PricingEngine> FdBlackScholesBarrierEnginePtr;
%}

%rename(FdBlackScholesBarrierEngine) FdBlackScholesBarrierEnginePtr;
class FdBlackScholesBarrierEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
typedef std::shared_ptr<PricingEngine> AnalyticBinaryBarrierEnginePtr;
%}
...
typedef std::shared_ptr<PricingEngine> BinomialBarrierEnginePtr;
%}
...
class BinomialBarrierEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
typedef std::shared_ptr<PricingEngine> ForwardEuropeanEnginePtr;
typedef std::shared_ptr<PricingEngine> QuantoEuropeanEnginePtr;
typedef std::shared_ptr<PricingEngine> QuantoForwardEuropeanEnginePtr;
%}


%rename(ForwardEuropeanEngine) ForwardEuropeanEnginePtr;
class ForwardEuropeanEnginePtr: public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
class QuantoEuropeanEnginePtr: public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
class QuantoForwardEuropeanEnginePtr: public std::shared_ptr<PricingEngine> {
public:
    %extend {
...
typedef std::shared_ptr<Instrument> ContinuousAveragingAsianOptionPtr;
typedef std::shared_ptr<Instrument> DiscreteAveragingAsianOptionPtr;
%}
...
class ContinuousAveragingAsianOptionPtr : public std::shared_ptr<Instrument> {
    #if defined(SWIGMZSCHEME) || defined(SWIGGUILE)
    %rename("dividend-rho")       dividendRho;
    #endif
  public:
...
class DiscreteAveragingAsianOptionPtr : public std::shared_ptr<Instrument> {
    #if defined(SWIGMZSCHEME) || defined(SWIGGUILE)
    %rename("dividend-rho")       dividendRho;
    #endif
  public:
...
typedef std::shared_ptr<PricingEngine> MCDiscreteArithmeticAPEnginePtr;
%}
...
typedef std::shared_ptr<PricingEngine> MCDiscreteArithmeticASEnginePtr;
%}
...
typedef std::shared_ptr<PricingEngine> MCDiscreteGeometricAPEnginePtr;
%}
  ...
  public:
    %extend {
        VarianceGammaEnginePtr(const VarianceGammaProcessPtr& process) {
            std::shared_ptr<VarianceGammaProcess> vgProcess =
                std::dynamic_pointer_cast<VarianceGammaProcess>(process);
...
class FFTVarianceGammaEnginePtr
  ...
  public:
    %extend {
        ...
        {
            std::dynamic_pointer_cast<FFTVarianceGammaEngine>(*self)->precalculate(optionList);
        }
    }
};
...
%{
using QuantLib::DoubleBarrierOption;
typedef std::shared_ptr<Instrument> DoubleBarrierOptionPtr;
%}

%rename(DoubleBarrierOption) DoubleBarrierOptionPtr;
class DoubleBarrierOptionPtr : public std::shared_ptr<Instrument> {
    #if defined(SWIGMZSCHEME) || defined(SWIGGUILE)
    %rename("dividend-rho")       dividendRho;
    %rename("implied-volatility") impliedVolatility;
    #endif
...
typedef std::shared_ptr<Instrument> QuantoDoubleBarrierOptionPtr;
%}
...
class QuantoDoubleBarrierOptionPtr : public DoubleBarrierOptionPtr {
  public:
    %extend {
        ...
        Real qvega() {
            return std::dynamic_pointer_cast<QuantoDoubleBarrierOption>(*self)
                ->qvega();
        }
        Real qrho() {
            return std::dynamic_pointer_cast<QuantoDoubleBarrierOption>(*self)
...
typedef std::shared_ptr<PricingEngine> AnalyticDoubleBarrierEnginePtr;
%}
...
typedef std::shared_ptr<PricingEngine> WulinYongDoubleBarrierEnginePtr;
%}
...
typedef std::shared_ptr<PricingEngine> VannaVolgaDoubleBarrierEnginePtr;
%}
...
%template(DeltaVolQuote) std::shared_ptr<DeltaVolQuote>;
IsObservable(std::shared_ptr<DeltaVolQuote>);

%extend std::shared_ptr<DeltaVolQuote> {
    ...
    shared_ptr<DeltaVolQuote>(Real delta,
        ...
        return new std::shared_ptr<DeltaVolQuote>(
...
typedef std::shared_ptr<PricingEngine> AnalyticDoubleBarrierBinaryEnginePtr;
%}
...
typedef std::shared_ptr<PricingEngine> BinomialDoubleBarrierEnginePtr;
%}
...
class BinomialDoubleBarrierEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
