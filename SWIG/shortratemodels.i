...
%template(ShortRateModel) std::shared_ptr<ShortRateModel>;
IsObservable(std::shared_ptr<ShortRateModel>);
...
%{
    ...
    using QuantLib::G2;
    typedef std::shared_ptr<ShortRateModel> VasicekPtr;
    typedef std::shared_ptr<ShortRateModel> HullWhitePtr;
    typedef std::shared_ptr<ShortRateModel> BlackKarasinskiPtr;
    typedef std::shared_ptr<ShortRateModel> G2Ptr;
%}

%rename(Vasicek) VasicekPtr;
class VasicekPtr : public std::shared_ptr<ShortRateModel> {
  public:
    %extend {
        ...
        DiscountFactor discount(Time t) const {
            return std::dynamic_pointer_cast<Vasicek>(*self)->discount(t);
        }
    }
};
...
class HullWhitePtr : public std::shared_ptr<ShortRateModel> {
  public:
    %extend {
        ...
        DiscountFactor discount(Time t) const {
            return std::dynamic_pointer_cast<HullWhite>(*self)->discount(t);
        }
    }
};

%rename(BlackKarasinski) BlackKarasinskiPtr;
class BlackKarasinskiPtr : public std::shared_ptr<ShortRateModel> {
  public:
    %extend {
...
%rename(G2) G2Ptr;
class G2Ptr : public std::shared_ptr<ShortRateModel> {
  public:
    %extend {
        ...
        DiscountFactor discount(Time t) const {
            return std::dynamic_pointer_cast<G2>(*self)->discount(t);
        }
    }
};
...
typedef std::shared_ptr<PricingEngine> JamshidianSwaptionEnginePtr;
typedef std::shared_ptr<PricingEngine> TreeSwaptionEnginePtr;
typedef std::shared_ptr<PricingEngine> AnalyticCapFloorEnginePtr;
typedef std::shared_ptr<PricingEngine> TreeCapFloorEnginePtr;
typedef std::shared_ptr<PricingEngine> G2SwaptionEnginePtr;
%}

%rename(JamshidianSwaptionEngine) JamshidianSwaptionEnginePtr;
class JamshidianSwaptionEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
        JamshidianSwaptionEnginePtr(
            ...
            std::shared_ptr<OneFactorAffineModel> m =
                 std::dynamic_pointer_cast<OneFactorAffineModel>(model);
...
class TreeSwaptionEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
class AnalyticCapFloorEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
class TreeCapFloorEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
...
class G2SwaptionEnginePtr : public std::shared_ptr<PricingEngine> {
  public:
    %extend {
        G2SwaptionEnginePtr(const std::shared_ptr<ShortRateModel>& model,
                            Real range, Size intervals) {
            std::shared_ptr<G2> g2 =
                std::dynamic_pointer_cast<G2>(model);
