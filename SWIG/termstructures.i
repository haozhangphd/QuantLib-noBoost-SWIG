...
%template(YieldTermStructure) std::shared_ptr<YieldTermStructure>;
IsObservable(std::shared_ptr<YieldTermStructure>);
...
typedef std::shared_ptr<YieldTermStructure> ImpliedTermStructurePtr;
%}

%rename(ImpliedTermStructure) ImpliedTermStructurePtr;
class ImpliedTermStructurePtr: public std::shared_ptr<YieldTermStructure> {
  public:
    %extend {
...
typedef std::shared_ptr<YieldTermStructure> ZeroSpreadedTermStructurePtr;
typedef std::shared_ptr<YieldTermStructure> ForwardSpreadedTermStructurePtr;
%}

%rename(ZeroSpreadedTermStructure) ZeroSpreadedTermStructurePtr;
class ZeroSpreadedTermStructurePtr
    : public std::shared_ptr<YieldTermStructure> {
  public:
    %extend {
...
typedef std::shared_ptr<YieldTermStructure> Name##Ptr;
}
%fragment("Name");

%rename(Name) Name##Ptr;
class Name##Ptr : public std::shared_ptr<YieldTermStructure> {
  public:
    %extend {
        Name##Ptr(
                const Handle<YieldTermStructure>& curveHandle,
...
typedef std::shared_ptr<YieldTermStructure> FlatForwardPtr;
%}

%rename(FlatForward) FlatForwardPtr;
class FlatForwardPtr : public std::shared_ptr<YieldTermStructure> {
  public:
    %extend {
