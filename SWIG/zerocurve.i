  ...
  public:
    %extend {
        ...
        const std::vector<Real>& data() {
            typedef InterpolatedZeroCurve<Interpolator> Name;
            return std::dynamic_pointer_cast<Name>(*self)->data();
        }
        ...
        const std::vector<Rate>& zeroRates() {
            typedef InterpolatedZeroCurve<Interpolator> Name;
            return std::dynamic_pointer_cast<Name>(*self)->zeroRates();
        }
...
%inline %{
    ZeroCurvePtr as_zerocurve(const std::shared_ptr<YieldTermStructure> & curve) {
        return std::dynamic_pointer_cast<QuantLib::ZeroCurve>(curve);
    }
%}
